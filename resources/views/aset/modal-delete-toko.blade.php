{{-- views/aset/modal-delete-toko.blade.php --}}
<div id="modalDeleteToko" class="fixed inset-0 hidden items-center justify-center z-[9999]">

    {{-- BACKDROP --}}
    <div class="absolute inset-0" onclick="closeModalDeleteToko()"
        ...
        ">
            ...
            ">
                ...
                <div style="font-size:0.8rem; color:#94a3b8; font-weight:500; margin-bottom:20px; line-height:1.5;">
                    ...
                    Data toko akan dihapus secara permanen.
                </div>
            </div>
            ...
            <div style="padding:0 28px 28px;">
                ...
                <form id="formDeleteToko" method="POST">
                    @csrf
                    <div style="position:relative; margin-bottom:20px;">
                        <div style="position:absolute; left:12px; top:50%; transform:translateY(-50%); display:flex; align-items:center; pointer-events:none;">
                        ...
                        <input type="password" name="password" id="deleteTokoPassword"
                            placeholder="Masukkan password EDP" required
                            style="
                                width:100%; padding:11px 14px 11px 38px;
                                border:1.5px solid #fecaca; border-radius:10px;
                                font-size:0.85rem; color:#374151; outline:none;
                                background:#fff8f8; font-family:'Plus Jakarta Sans',sans-serif;
                    ...
                    <div style="display:flex; gap:10px;">
                        <button type="button" onclick="closeModalDeleteToko()" style="
                            flex:1; padding:11px; background:#f8fafc; border:1.5px solid #e2e8f0;
...
<script>
function closeModalDeleteToko() {
    document.getElementById('modalDeleteToko').classList.add('hidden');
    document.getElementById('modalDeleteToko').classList.remove('flex');
    document.getElementById('deleteTokoPassword').value = '';
}
function openModalDeleteToko(id, namaToko) {
    document.getElementById('deleteTokoInfo').textContent = namaToko || 'ID: ' + id;
    document.getElementById('formDeleteToko').action = '/koneksitoko/delete/' + id;
    document.getElementById('deleteTokoPassword').value = '';
    document.getElementById('modalDeleteToko').classList.remove('hidden');
    document.getElementById('modalDeleteToko').classList.add('flex');
}
</script>